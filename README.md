...
## Method
1. 框架主体：  
框架就是主流的[Fast-lio](https://github.com/hku-mars/FAST_LIO) ，这里不多介绍了  
2. 动态物体滤除思路：
- 地面点分割模块[patchwork++](https://github.com/M-Evanovic/patchwork-plus-plus)
...
## Function
重要模块和函数的介绍都放在[notice.md](https://github.com/M-Evanovic/LiDAR-IMU-odometry-with-dynamic-object-filter/blob/main/notice.md)
